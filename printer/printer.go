...
// New create a Printer printer
func New(dst io.Writer) (e *Printer) {
	e = &Printer{dst: dst}
	e.reset()
	return
}
...
// Write a new Line
func (e *Printer) NewLine() (int, error) {
	return e.WriteRaw([]byte("\n"))
}

func (e *Printer) DashLine() (int, error) {
	return e.WriteRaw([]byte("--------------------------------\n"))
}
...
func (e *Printer) BanFeedButton(n uint8) {
...
func (e *Printer) FormfeedD(n uint8) {
	if n < 0 {
		n = 0
	} else if n > 255 {
		n = 255
...
func (e *Printer) FormfeedN(n uint8) {
	if n < 0 {
		n = 0
	} else if n > 255 {
		n = 255
...
func (e *Printer) SetMoveX(x uint16) {
	e.sendMoveX(x)
}
...
func (e *Printer) SetLineSpace(n ...uint8) {
	var s string
	switch len(n) {
	case 0:
		s = string([]byte{'\x1B', '2'})
